...
CRF_MODEL_PATH = os.path.join(MYDIR, "all_train.model")
TANIMOTO_MAPPING_PATH = os.path.join(MYDIR, "tanimoto_mapping.json")
VOCAB_PATH = os.path.join(MYDIR, "tfidf_vocab.json")
IDF_WEIGHTS_PATH = os.path.join(MYDIR, "tfidf_idf.json")
